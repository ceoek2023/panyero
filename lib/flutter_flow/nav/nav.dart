...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) => _RouteErrorBuilder(
        state: state,
        child:
            appStateNotifier.loggedIn ? const HomePageWidget() : const Auth3CreateWidget(),
      ),
      routes: [
        FFRoute(
          name: '_initialize',
        ...
        FFRoute(
          name: 'teamMembers',
          path: '/teamMembers',
          builder: (context, params) => const TeamMembersWidget(),
        ),
        FFRoute(
          name: 'billing',
          path: '/billing',
        ...
        FFRoute(
          ...
          builder: (context, params) => const TeamMembersClientsWidget(),
        ),
        FFRoute(
          name: 'Allservices',
          path: '/allservices',
          builder: (context, params) => const AllservicesWidget(),
        ),
        FFRoute(
          name: 'auth_3_Create',
          path: '/auth3Create',
        ...
        FFRoute(
          name: 'HorseRace',
          path: '/horseRace',
          builder: (context, params) => const HorseRaceWidget(),
        ),
        FFRoute(
          name: 'Profile',
          path: '/profile',
        ...
        FFRoute(
          name: 'Vmode',
          path: '/vmode',
          builder: (context, params) => const VmodeWidget(),
        )
