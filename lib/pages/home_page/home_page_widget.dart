  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      await currentUserReference!.update(createUsersRecordData(
        linkGame: 'https://fulldemo.viserlab.com/demo/xaxino_vua5/',
      ));
    });
                                                                        ...
                                                                        Text(
                                                                          ...
                                                                          style: FlutterFlowTheme.of(context)
                                                                              ...
                                                                              .override(
                                                                                ...
                                                                                letterSpacing: 0.0,
                                                                                fontWeight: FontWeight.normal,
                                                                                useGoogleFonts: GoogleFonts.asMap().containsKey('Roboto Mono'),
                                                                              ),
                                                                        ),
                                                                        Text(
                                                                          dateTimeFormat(
                                                                      ...
                                                                      children: [
                                                                        AuthUserStreamWidget(
                                                                          builder: (context) =>
                                                                            ...
                                                                            valueOrDefault<String>(
                                                                              formatNumber(
                                                                                valueOrDefault(currentUserDocument?.transferred, 0),
                                                                                formatType: FormatType.decimal,
                                                                                decimalType: DecimalType.automatic,
                                                                              ),
                                                                              '0.00',
                                                                        ...
                                                                        children: [
                                                                          AuthUserStreamWidget(
                                                                            builder: (context) =>
                                                                              ...
                                                                              valueOrDefault<String>(
                                                                                formatNumber(
                                                                                  valueOrDefault(currentUserDocument?.recieved, 0),
                                                                                  formatType: FormatType.decimal,
                                                                                  decimalType: DecimalType.automatic,
                                                                                ),
                                                                                '0.00',
